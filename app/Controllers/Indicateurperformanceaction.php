...
class Indicateurperformanceaction extends BaseController
{
    /**
    ...
    {
        $model = new IndicateurPerformanceActionModel();
        return $this->getResponse(
            [
                'message' => 'IndicateurPerformanceAction retrieved',
                'IndicateurPerformanceActions' => $model->findAll()
            ]
        );
    }
